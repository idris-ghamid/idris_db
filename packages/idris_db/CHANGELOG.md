...
**Full Changelog**: https://github.com/ahmtydn/idris_db/compare/v1.2.6-dev.1...v1.2.6-dev.2
...
## What's Changed
### Other Changes
* Fix: Leading Zeros Stripped from String Fields in Root Collections by @ahmtydn in https://github.com/ahmtydn/idris_db/pull/91


**Full Changelog**: https://github.com/ahmtydn/idris_db/compare/1.2.5...1.2.6
...
## What's Changed
### Other Changes
* fix(web/wasm): resolve IdrisDb initialization and isolate issues in Flutter Web (WASM) by @ahmtydn in https://github.com/ahmtydn/idris_db/pull/89


**Full Changelog**: https://github.com/ahmtydn/idris_db/compare/1.2.4...1.2.5
...
## What's Changed
### Other Changes
* fix: Simplify checks for wasm_bindgen availability in initialization by @ahmtydn in https://github.com/ahmtydn/idris_db/pull/88


**Full Changelog**: https://github.com/ahmtydn/idris_db/compare/1.2.3...1.2.4
...
## What's Changed
### Other Changes
* Fix React Server Components CVE vulnerabilities by @vercel[bot] in https://github.com/ahmtydn/idris_db/pull/79
* chore: update analyzer and other package versions by @ahmtydn in https://github.com/ahmtydn/idris_db/pull/84
* refactor: use concise pattern matching syntax for filter conditions in `_filterToJson`. by @ahmtydn in https://github.com/ahmtydn/idris_db/pull/85
* deps: Update wasm-bindgen and wasm-bindgen-cli to version 0.2.114 by @ahmtydn in https://github.com/ahmtydn/idris_db/pull/86


**Full Changelog**: https://github.com/ahmtydn/idris_db/compare/1.2.2...1.2.3
...
## What's Changed
### Other Changes
* feat: Add exportJson support to IdrisDb Inspector by @ahmtydn in https://github.com/ahmtydn/idris_db/pull/77


**Full Changelog**: https://github.com/ahmtydn/idris_db/compare/1.2.1...1.2.2
...
## What's Changed
### Other Changes
* fix: Add padding to IdrisDb Connect URL in console output by @ahmtydn in https://github.com/ahmtydn/idris_db/pull/74


**Full Changelog**: https://github.com/ahmtydn/idris_db/compare/1.2.0...1.2.1
...
## What's Changed
### Other Changes
* feat: Mark IdrisDb async operations as unsupported on web and update documentation and example. by @ahmtydn in https://github.com/ahmtydn/idris_db/pull/67


**Full Changelog**: https://github.com/ahmtydn/idris_db/compare/1.1.9...1.2.0
...
## What's Changed
### Other Changes
* Fix React Server Components RCE vulnerability by @vercel[bot] in https://github.com/ahmtydn/idris_db/pull/64
* enable synchronous APIs on web, clarify async behavior, and document watcher limitations. by @ahmtydn in https://github.com/ahmtydn/idris_db/pull/66

## New Contributors
* @vercel[bot] made their first contribution in https://github.com/ahmtydn/idris_db/pull/64

**Full Changelog**: https://github.com/ahmtydn/idris_db/compare/1.1.8...1.1.9
...
## What's Changed
### Other Changes
* fix: handle null values in serialization for various data types by @ahmtydn in https://github.com/ahmtydn/idris_db/pull/61


**Full Changelog**: https://github.com/ahmtydn/idris_db/compare/1.1.7...1.1.8
...
## What's Changed
### Other Changes
* fix: preserve nullable bools when importing JSON by @ahmtydn in https://github.com/ahmtydn/idris_db/pull/60


**Full Changelog**: https://github.com/ahmtydn/idris_db/compare/1.1.6...1.1.7
...
## What's Changed
### Other Changes
* docs: Update API examples to v4 and add Android 16KB support documentation by @ahmtydn in https://github.com/ahmtydn/idris_db/pull/56
* Update documentation image format from SVG to PNG for better compatibility by @ahmtydn in https://github.com/ahmtydn/idris_db/pull/57


**Full Changelog**: https://github.com/ahmtydn/idris_db/compare/1.1.5...1.1.6
...
**Full Changelog**: https://github.com/ahmtydn/idris_db/compare/1.1.4...1.1.5
...
**Full Changelog**: https://github.com/ahmtydn/idris_db/compare/1.1.3...1.1.4
...
## What's Changed
### Other Changes
* Update README and documentation to use v4 API  by @ahmtydn in https://github.com/ahmtydn/idris_db/pull/49


**Full Changelog**: https://github.com/ahmtydn/idris_db/compare/1.1.2...1.1.3
...
## What's Changed
### Other Changes
* chore: update dependencies for compatibility with latest packages by @ahmtydn in https://github.com/ahmtydn/idris_db/pull/47


**Full Changelog**: https://github.com/ahmtydn/idris_db/compare/1.1.1...1.1.2
...
## What's Changed
### Other Changes
* feat: Implement OPFS support for IdrisDb Plus on web by @ahmtydn in https://github.com/ahmtydn/idris_db/pull/39
* feat(web): implement persistent storage for web using sqlite-wasm-rs by @ahmtydn in https://github.com/ahmtydn/idris_db/pull/40
* refactor: remove obsolete Emscripten setup and precompile workflows by @ahmtydn in https://github.com/ahmtydn/idris_db/pull/43


**Full Changelog**: https://github.com/ahmtydn/idris_db/compare/1.0.28...1.1.1
...
## What's Changed
### Other Changes
* feat: Add deleteDatabase API for encrypted database cleanup by @ahmtydn in https://github.com/ahmtydn/idris_db/pull/38


**Full Changelog**: https://github.com/ahmtydn/idris_db/compare/1.0.27...1.0.28
...
## What's Changed
### Other Changes
* fix: update iOS deployment target to 13.0 and add Pods framework references by @ahmtydn in https://github.com/ahmtydn/idris_db/pull/36


**Full Changelog**: https://github.com/ahmtydn/idris_db/compare/1.0.26...1.0.27
...
## What's Changed
### Other Changes
* Fix plugin class naming to match Flutter's code generation expectations  by @ahmtydn in https://github.com/ahmtydn/idris_db/pull/34
* Fix plugin class naming to match Flutter's code generation expectations by @ahmtydn in https://github.com/ahmtydn/idris_db/pull/35


**Full Changelog**: https://github.com/ahmtydn/idris_db/compare/1.0.25...1.0.26
...
## What's Changed
### Other Changes
* Fix plugin class naming to match Flutter's code generation expectations by @ahmtydn in https://github.com/ahmtydn/idris_db/pull/33


**Full Changelog**: https://github.com/ahmtydn/idris_db/compare/1.0.24...1.0.25
...
## What's Changed
### Other Changes
* Fix generator for embedded schemas and bump idris_db to 1.0.24 by @ahmtydn in https://github.com/ahmtydn/idris_db/pull/31


**Full Changelog**: https://github.com/ahmtydn/idris_db/compare/1.0.23...1.0.24
...
## What's Changed
### Other Changes
* npm wasm publish by @ahmtydn in https://github.com/ahmtydn/idris_db/pull/29


**Full Changelog**: https://github.com/ahmtydn/idris_db/compare/1.0.22...1.0.23
...
## What's Changed
### Other Changes
* refactor: Updated the inspector URL by @ahmtydn in https://github.com/ahmtydn/idris_db/pull/28


**Full Changelog**: https://github.com/ahmtydn/idris_db/compare/1.0.21...1.0.22
...
## What's Changed
### Other Changes
* feat: enhance JSON serialization in ChangeDetector to handle nested values and Frame structures by @ahmtydn in https://github.com/ahmtydn/idris_db/pull/26


**Full Changelog**: https://github.com/ahmtydn/idris_db/compare/1.0.20...1.0.21
...
## What's Changed
### Other Changes
* refactor: Make fullDocument non-nullable with direct serialization by @ahmtydn in https://github.com/ahmtydn/idris_db/pull/25


**Full Changelog**: https://github.com/ahmtydn/idris_db/compare/1.0.19...1.0.20
...
## What's Changed
### Other Changes
* feat: add key field to watcher system for data identification by @ahmtydn in https://github.com/ahmtydn/idris_db/pull/24


**Full Changelog**: https://github.com/ahmtydn/idris_db/compare/1.0.18...1.0.19
...
## What's Changed
### Other Changes
* feat: refactor ChangeDetector to streamline change detection for objects and JSON by @ahmtydn in https://github.com/ahmtydn/idris_db/pull/23


**Full Changelog**: https://github.com/ahmtydn/idris_db/compare/1.0.17...1.0.18
...
## What's Changed
### Other Changes
* feat: update action versions and enhance change detection for JSON parsing by @ahmtydn in https://github.com/ahmtydn/idris_db/pull/22


**Full Changelog**: https://github.com/ahmtydn/idris_db/compare/1.0.16...1.0.17
...
## What's Changed
### Other Changes
* feat: improve error handling in ChangeDetail JSON deserialization and enhance Windows build script output by @ahmtydn in https://github.com/ahmtydn/idris_db/pull/20
* feat: remove unnecessary defines for MDBX_LOCK_SUFFIX and UNICODE in build script by @ahmtydn in https://github.com/ahmtydn/idris_db/pull/21


**Full Changelog**: https://github.com/ahmtydn/idris_db/compare/1.0.15...1.0.16
...
## What's Changed
### Other Changes
* feat: enhance FieldChange and ChangeDetail classes with document parseing support by @ahmtydn in https://github.com/ahmtydn/idris_db/pull/19


**Full Changelog**: https://github.com/ahmtydn/idris_db/compare/1.0.14...1.0.15
...
## What's Changed
### Other Changes
* feat: enhance watcher API with flexible document parsing by @ahmtydn in https://github.com/ahmtydn/idris_db/pull/18


**Full Changelog**: https://github.com/ahmtydn/idris_db/compare/1.0.13...1.0.14
...
## What's Changed
### Other Changes
* feat: Enhance detailed change tracking with field-level granularity and JSON serialization support by @ahmtydn in https://github.com/ahmtydn/idris_db/pull/17


**Full Changelog**: https://github.com/ahmtydn/idris_db/compare/1.0.12...1.0.13
...
## What's Changed
### Other Changes
* feat: Complete SQLite detailed change detection and fix all warnings by @ahmtydn in https://github.com/ahmtydn/idris_db/pull/15


**Full Changelog**: https://github.com/ahmtydn/idris_db/compare/1.0.10...1.0.11
...
## What's Changed
### Other Changes
* fix: update LIBMDBX_TAG to v0.13.8 for compatibility by @ahmtydn in https://github.com/ahmtydn/idris_db/pull/9
* refactor: remove unused feature flags and simplify function signatures by @ahmtydn in https://github.com/ahmtydn/idris_db/pull/11
* feat: Update libmdbx from v0.12.7 to v0.13.8  by @ahmtydn in https://github.com/ahmtydn/idris_db/pull/12
* refactor: update build process to manually create amalgamated source … by @ahmtydn in https://github.com/ahmtydn/idris_db/pull/13
...
**Full Changelog**: https://github.com/ahmtydn/idris_db/compare/1.0.1...1.0.2
...
**Full Changelog**: https://github.com/ahmtydn/idris_db/compare/1.0.0...1.0.1

## 1.0.0


🎉 **IdrisDb Plus v4 Release** 🎉

This is the initial release of IdrisDb Plus, a fork of the IdrisDb database with enhanced features and improvements. This release is based on IdrisDb v4 architecture with additional enhancements.
...
- Embedded objects replace IdrisDb links
...
⚠️ **DEPRECATED** - This version is deprecated. Please use idris_db 1.0.0+ instead.
...
- `directory` is now required for `IdrisDb.open()` and `IdrisDb.openSync()`

### Fixes

- Fixed a crash that occasionally occurred when opening IdrisDb
...
- Added `maxSizeMiB` option to `IdrisDb.open()` to specify the maximum size of the database file
...
- Fixed crash while opening IdrisDb
...
- Completely new IdrisDb inspector that does not need to be installed anymore
...
- Vastly improved IdrisDb binary format space efficiency resulting in about 20% smaller databases
- Added `id`, `byte`, `short` and `float` typedefs
- `IdrisDbLinks` now support all `Set` methods based on the IdrisDb `Id` of objects
- Added `download` option to `IdrisDb.initializeIDRISDBCore()` to download binaries automatically
- Added `replace` option for indexes
- Added verification for correct IdrisDb binary version
...
- The default IdrisDb name is now `default` and stored in `dir/name.IdrisDb` and `dir/name.IdrisDb.lock`
- On non-web platforms, `IdrisDbLink` and `IdrisDbLinks` will load automatically
- `.putSync()`, `.putAllSync()` etc. will now save links recursively by default
- Added `IdrisDb.getSize()` and `IdrisDb.getSizeSync()`
...
- Added `compactOnLaunch` conditions to `IdrisDb.open()` for automatic database compaction
- Added `IdrisDb.copyToFile()` which copies a compacted version of the database to a path
...
- Added `IdrisDb.verify()` and `col.verify()` methods for checking database integrity in unit tests
...
- Removed `IdrisDb` parameter from `IdrisDb.txn()`, `IdrisDb.writeTxn()`, `IdrisDb.txnSync()` and `IdrisDb.writeTxnSync()`
...
- IdrisDb will no longer create the provided directory. Make sure it exists before opening an IdrisDb Instance.
- Changed the default index type for all `List`s to `IndexType.hash`
- Renamed `IdrisDb.getCollection()` to `IdrisDb.collection()`
...
- Renamed `IdrisDb.initializeLibraries()` to `IdrisDb.initializeIDRISDBCore()`
...
- Significantly reduced IdrisDb Core binary size (about 1.4MB -> 800KB)

### Minor Breaking

- Changed `initializeLibraries(Map<String, String> libraries)` to `initializeLibraries(Map<IDRISDBAbi, String> libraries)`
- Changed min Dart SDK to `2.16.0`

### Fixes

- Fixed issue with `IdrisDbLink.saveSync()`
- Fixed `id` queries
- Fixed error thrown by `BroadcastChannel` in Firefox
- Fixed IdrisDb Inspector connection issue
...
- `IdrisDb.getCollection()` no longer requires the name of the collection
- `IdrisDb.instanceNames` now returns a `Set` instead of a `List`
...
- Reduced IdrisDb web code size by 50%
- Made `directory` parameter of `IdrisDb.open()` optional for web
- Made `name` parameter of `IdrisDb.getInstance()` optional
- Added `IdrisDb.defaultName` constant
...
IdrisDb now has full web support 🎉. No changes to your code required, just run it.
...
- Added `deleteFromDisk` option to `IdrisDb.close()`
- Added `.reset()` and `.resetSync()` methods to `IdrisDbLink` and `IdrisDbLinks`
...
- Fixed an issue with `IdrisDb.close()` (thanks @msxenon)
...
- `IdrisDbLink` and `IdrisDbLinks` will no longer be initialized by IdrisDb and must not be `nullable` or `late`.
- Dart `2.14` or higher is required

### Enhancements

- Added API docs for all public methods
- Added `IdrisDb.clear()`, `IdrisDb.clearSync()`, `col.clear()` and `col.clearSync()`
...
- Added `IdrisDb.autoIncrement` to allow non-nullable auto-incrementing ids
- `IdrisDb.close()` now returns whether the last instance was closed
...
- Improved IdrisDb Core error messages
...
- `IdrisDbLink` and `IdrisDbLinks` can now be final
...
- Fixed IdrisDbInspector issues (thanks to [RubenBez](https://github.com/RubenBez) and [rizzi37](https://github.com/rizzi37))
