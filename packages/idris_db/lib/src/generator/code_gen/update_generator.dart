...
const List<IdrisDbType> _updateableTypes = [
  IdrisDbType.bool,
  IdrisDbType.byte,
  IdrisDbType.int,
  IdrisDbType.long,
...
String _generateUpdate(ObjectInfo oi) {
  ...
  class _${oi.dartName}UpdateImpl implements _${oi.dartName}Update {
    ...
    final IdrisDbCollection<${oi.idProperty!.dartType}, ${oi.dartName}> collection;
  ...
  extension ${oi.dartName}Update on IdrisDbCollection<${oi.idProperty!.dartType}, ${oi.dartName}> {
  ...
  class _${oi.dartName}QueryUpdateImpl implements _${oi.dartName}QueryUpdate {
    ...
    final IdrisDbQuery<${oi.dartName}> query;
    final int? limit;
  ...
  extension ${oi.dartName}QueryUpdate on IdrisDbQuery<${oi.dartName}> {
