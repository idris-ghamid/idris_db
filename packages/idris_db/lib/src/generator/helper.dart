...
// Updated for analyzer 9.0+ compatibility
// Using TypeChecker with package URI instead of fromRuntime
final _collectionChecker = TypeChecker.fromUrl('package:idris_db/idris_db.dart#Collection');
final _embeddedChecker = TypeChecker.fromUrl('package:idris_db/idris_db.dart#Embedded');
final _enumPropertyChecker = TypeChecker.fromUrl('package:idris_db/idris_db.dart#EnumValue');
final _idChecker = TypeChecker.fromUrl('package:idris_db/idris_db.dart#Id');
final _ignoreChecker = TypeChecker.fromUrl('package:idris_db/idris_db.dart#Ignore');
final _nameChecker = TypeChecker.fromUrl('package:idris_db/idris_db.dart#Name');
final _indexChecker = TypeChecker.fromUrl('package:idris_db/idris_db.dart#Index');
final _utcChecker = TypeChecker.fromUrl('package:idris_db/idris_db.dart#Utc');
...
void _checkidrisDbName(String name, Element element) {
