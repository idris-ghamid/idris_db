  ...
  group('Inheritance', () {
    ...
    setUp(() async {
      ...
      IdrisDb.write((IdrisDb) {
        IdrisDb.inheritingModels.putAll([
          inheritingObj0,
          inheritingObj1,
          inheritingObj2,
          inheritingObj3,
        ...
        IdrisDb.nonInheritingModels.putAll([
          nonInheritingObj0,
          nonInheritingObj1,
          nonInheritingObj2,
        ]);
    ...
    IdrisDbTest('Query model with inheritance', () {
      expect(
        IdrisDb.inheritingModels
            .where()
            .nameContains('1')
            .or()
            .nameContains('4')
      ...
      expect(IdrisDb.inheritingModels.where().ageLessThan(40).findAll(), [
        inheritingObj1,
        inheritingObj2,
        inheritingObj4,
        inheritingObj5,
    ...
    /*IdrisDbTest('Query model with inherited index', () {
      expect(
        IdrisDb.inheritingModels
            .where()
      ...
      expect(
        IdrisDb.inheritingModels.where().findAll(),
        [
          inheritingObj0,
          inheritingObj1,
          inheritingObj2,
    ...
    IdrisDbTest('Query model without inheritance', () {
      expect(
        IdrisDb.nonInheritingModels.where().ageBetween(30, 60).findAll(),
        [nonInheritingObj1],
      );

      expect(
        IdrisDb.nonInheritingModels
            .where()
      ...
      expect(
        IdrisDb.nonInheritingModels.where().idGreaterThan(1).findAll(),
