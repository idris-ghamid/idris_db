...
void main() {
  group('Filter list length', () {
    ...
    setUp(() async {
      ...
      IdrisDb.write((IdrisDb) => IdrisDb.models.putAll([obj1, obj2, obj3, obj4, obj5]));
    });

    IdrisDbTest('.isEmpty()', () {
      expect(IdrisDb.models.where().boolsIsEmpty().findAll(), [obj1]);
      expect(IdrisDb.models.where().intsIsEmpty().findAll(), [obj5]);
      expect(IdrisDb.models.where().doublesIsEmpty().findAll(), [obj5]);
      expect(IdrisDb.models.where().stringsIsEmpty().findAll(), isEmpty);
    });

    IdrisDbTest('.isNotEmpty()', () {
      expect(IdrisDb.models.where().boolsIsNotEmpty().findAll(), [
        obj2,
        obj3,
        obj4,
        obj5,
      ]);
      expect(IdrisDb.models.where().intsIsNotEmpty().findAll(), [
        obj1,
        obj2,
        obj3,
        obj4,
      ]);
      expect(IdrisDb.models.where().doublesIsNotEmpty().findAll(), [
        obj1,
        obj2,
        obj3,
        obj4,
      ]);
      expect(IdrisDb.models.where().stringsIsNotEmpty().findAll(), [
        obj2,
        obj3,
        obj4,
        obj5,
