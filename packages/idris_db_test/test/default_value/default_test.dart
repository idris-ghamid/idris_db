...
void main() {
  group('Default value', () {
    IdrisDbTest('scalar', web: false, () async {
      ...
      IDRISDB1.write((IdrisDb) => IDRISDB1.emptyModels.put(emptyObj));
      final idrisDbName = IDRISDB1.name;
      IDRISDB1.close();

      final IDRISDB2 = await openTempIDRISDB([DefaultModelSchema], name: idrisDbName);
      final obj = IDRISDB2.defaultModels.get(0)!;
    ...
    IdrisDbTest('scalar property', web: false, () async {
      ...
      final IDRISDB2 = await openTempIDRISDB([DefaultModelSchema], name: idrisDbName);
      final col = IDRISDB2.defaultModels;
    ...
    IdrisDbTest('list', web: false, () async {
      ...
      final obj = IDRISDB2.defaultListModels.get(0)!;
    ...
    IdrisDbTest('list property', web: false, () async {
      ...
      final col = IDRISDB2.defaultListModels;
