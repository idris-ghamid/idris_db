...
void main() {
  group('Nullable value', () {
    IdrisDbTest('scalar', web: false, () async {
      ...
      final IDRISDB2 = await openTempIDRISDB([NullableModelSchema], name: idrisDbName);
      final obj = IDRISDB2.nullableModels.get(0)!;
    ...
    IdrisDbTest('scalar property', web: false, () async {
      ...
      final IDRISDB2 = await openTempIDRISDB([NullableModelSchema], name: idrisDbName);
      final col = IDRISDB2.nullableModels;
    ...
    IdrisDbTest('list', web: false, () async {
      ...
      final obj = IDRISDB2.nullableListModels.get(0)!;
      expect(obj.boolValue, null);
      expect(obj.shortValue, null);
      expect(obj.intValue, null);
      expect(obj.floatValue, null);
    ...
    IdrisDbTest('list property', web: false, () async {
      ...
      final col = IDRISDB2.nullableListModels;
      expect(col.where().boolValueProperty().findFirst(), null);
      expect(col.where().shortValueProperty().findFirst(), null);
      expect(col.where().intValueProperty().findFirst(), null);
      expect(col.where().floatValueProperty().findFirst(), null);
