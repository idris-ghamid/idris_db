...
use crate::native::IDRISDB_deserializer::IDRISDBDeserializer;
...
impl NativeFilter {
    ...
    pub(crate) fn evaluate(&self, id: i64, object: IDRISDBDeserializer) -> bool {
...
trait Condition {
    fn evaluate(&self, id: i64, object: IDRISDBDeserializer) -> bool;
}
...
impl Condition for IsNullCond {
    fn evaluate(&self, _id: i64, object: IDRISDBDeserializer) -> bool {
...
impl Condition for IdBetweenCond {
    #[inline]
    fn evaluate(&self, id: i64, _object: IDRISDBDeserializer) -> bool {
...
impl Condition for StaticCond {
    fn evaluate(&self, _id: i64, _: IDRISDBDeserializer) -> bool {
        self.value
    }
}
