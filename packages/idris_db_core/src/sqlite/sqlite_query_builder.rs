...
impl<'a> IDRISDBQueryBuilder for SQLiteQueryBuilder<'a> {
...
mod test {
    ...
    fn test_filter_equal_value() {
        let value = IDRISDBValue::Integer(123);
    ...
    fn test_filter_less_than_value_case_insensitive() {
        let value = IDRISDBValue::String("abc".to_string());
    ...
    fn test_filter_between_value() {
        let value1 = IDRISDBValue::Integer(123);
        let value2 = IDRISDBValue::Integer(456);
    ...
    fn test_filter_between_lower_null() {
        let value = IDRISDBValue::Integer(456);
    ...
    fn test_filter_string_starts_with() {
        let value = IDRISDBValue::String("ab%c".to_string());
        ...
        assert_eq!(
            params,
            vec![QueryParam::Value(IDRISDBValue::String("ab\\%c%".to_string()))]
        );
    }
    ...
    fn test_filter_string_matches() {
        let value = IDRISDBValue::String("a?b%c*".to_string());
        ...
        assert_eq!(
            params,
            vec![QueryParam::Value(IDRISDBValue::String("a_b\\%c%".to_string()))]
        );
    }
