...
use crate::core::{data_type::DataType, writer::IDRISDBWriter};
...
impl<'a> IDRISDBWriter<'a> for SQLiteInsert<'a> {
...
impl<'a> IDRISDBWriter<'a> for SQLiteObjectWriter<'a> {
    type ObjectWriter = SQLiteObjectWriter<'a>;
...
impl<'a> IDRISDBWriter<'a> for SQLiteListWriter<'a> {
    type ObjectWriter = SQLiteObjectWriter<'a>;
