# IdrisDb Binary Format Documentation

The IdrisDb binary format is designed to efficiently store objects and allow quick random access to properties, with an emphasis on minimizing read operations. This document provides an overview of the format, its supported data types, and small examples to illustrate its usage.
...
The IdrisDb binary format supports the following data types:
...
The IdrisDb binary format consists of three parts:
